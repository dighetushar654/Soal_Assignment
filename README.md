...
# Assignment_1
* Find fifteen git commands and what they do? Share a file here.

# Assignment_2
* run code on the link and paste question, answer and output in README.md file for new create Repository
